...
-- 
-- "Path\\To\\Music\\File.mp3" is the path to the music file relative to the main folder
-- This can either be wrapped in [[double square brackets]] with \single\backslash\ directory separators or in "quotation marks" with \\double\\backslash\\ directory separators.
...
-- Note that this version depends on the mp3info program, available from the link below (or possibly your OS's package manager):
